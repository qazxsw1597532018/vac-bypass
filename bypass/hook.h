...
// modifies page flags before copying memory to avoid access violations
...
// returns free bytes from the allocated trampoline page
...
// remove a hook, allowing the original function to be called
...
// modifies a function to jump to ours
